...
function initTags() {
	...
	// create main object
	var mainPara = getTextElement( "tags", "{ tags }", null, fonts["menu"], w.menuColor, ["async", "tags"], "pointer");
	tags['menu'].push({ 
		"id" : "tags",
		"txt" : mainPara
	});
	var allPara = getTextElement( "all", "all", null, fonts["menu"], w.menuColor, ["async", "tags"], "pointer");
	tags['menu'].push({ 
		"id" : "all",
		"txt" : allPara
	});
	...
	$.each(allTagKeys, function(ti, tag) {
		var para = getTextElement( tag, tag, null, fonts["menu"], w.menuColor, ["async", "tags"], "pointer");
		tags['menu'].push({
			"id" : tag,
			"txt" : para
		});
